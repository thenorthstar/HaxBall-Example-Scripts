        ...
        if (scores == null) {
            ...
            if (roomObject.xpSessionFeatureActive == false) {
                ...
                if (roomObject.xpSession == false) {
                    ...
                    if (JSON.parse(localStorage.getItem("playerList"))[player.name].hasBet == true) {
    ...
    if (message.split(" ")[0] == commands[2]) {
        if (player.admin == true) {
            if (roomObject.xpSessionFeatureActive == false) {
                ...
                var bets = room.getPlayerList().filter(p => JSON.parse(localStorage.getItem("playerList"))[p.name].hasBet == true);
                if (bets) {
                    bets.forEach(b => {
                        room.sendAnnouncement(`${b.name}: ${JSON.parse(localStorage.getItem("playerList"))[b.name].bet.red}-${JSON.parse(localStorage.getItem("playerList"))[b.name].bet.blue} (${JSON.parse(localStorage.getItem("playerList"))[b.name].xpMultiplier})`, player.id, colors.Chat.Admin.Bets.List, fonts.Chat.Admin.Bets.List, sounds.Chat.Admin.Bets.List);
                    });
                    return false;
                }
                else {
...
function chat_stats(player, message) {
    if (message.split(" ")[0] == commands[4]) {
        ...
        var index = JSON.parse(localStorage.getItem("playerListArray")).findLastIndex(p => p.id == player.id || p.auth == JSON.parse(localStorage.getItem("playerList"))[player.name].auth || p.conn == JSON.parse(localStorage.getItem("playerList"))[player.name].conn);
        if (index === -1) {
            ...
            var p = JSON.parse(localStorage.getItem("playerListArray"))[index];
...
function getPreviousAccounts(name) {
    return JSON.parse(localStorage.getItem("playerListArray")).filter(p => p.auth == JSON.parse(localStorage.getItem("playerList"))[name].auth || p.auth == JSON.parse(localStorage.getItem("playerList"))[name].conn);
}
...
function resetStats() {
    var players = room.getPlayerList().filter(p => JSON.parse(localStorage.getItem("playerList"))[p.name].hasBet == true || JSON.parse(localStorage.getItem("playerList"))[p.name].bet.red != 0 || JSON.parse(localStorage.getItem("playerList"))[p.name].bet.blue != 0 || JSON.parse(localStorage.getItem("playerList"))[p.name].xpMultiplier != 1);
    if (players) {
        players.forEach(p => {
...
function updateXPs(scores) {
    var bets = room.getPlayerList().filter(p => JSON.parse(localStorage.getItem("playerList"))[p.name].hasBet == true);
    var losers = bets.filter(b => JSON.parse(localStorage.getItem("playerList"))[b.name].bet.red != scores.red || JSON.parse(localStorage.getItem("playerList"))[b.name].bet.blue != scores.blue);
    var winners = bets.filter(b => JSON.parse(localStorage.getItem("playerList"))[b.name].bet.red == scores.red && JSON.parse(localStorage.getItem("playerList"))[b.name].bet.blue == scores.blue);

    losers.forEach(l => {
        playerList[l.name].xp += JSON.parse(localStorage.getItem("playerList"))[l.name].xpMultiplier * roomObject.xpUpdate.lose;
        room.sendAnnouncement(`${messages.Victory.Betting.Lose} ${Math.abs(JSON.parse(localStorage.getItem("playerList"))[l.name].xpMultiplier * roomObject.xpUpdate.lose)} XPs`, l.id, colors.Victory.Betting.Lose, fonts.Victory.Betting.Lose, sounds.Victory.Betting.Lose);
    });
    winners.forEach(w => {
        playerList[w.name].xp += JSON.parse(localStorage.getItem("playerList"))[w.name].xpMultiplier * roomObject.xpUpdate.win;
        room.sendAnnouncement(`${messages.Victory.Betting.Win} ${Math.abs(JSON.parse(localStorage.getItem("playerList"))[w.name].xpMultiplier * roomObject.xpUpdate.win)} XPs`, w.id, colors.Victory.Betting.Win, fonts.Victory.Betting.Win, sounds.Victory.Betting.Win);
    });
    localStorage.setItem("playerList",JSON.stringify(playerList))
}
...
room.onPlayerJoin = function (player) {
    if (playerList[player.name] == undefined) {
        playerList[player.name] = { name: player.name, auth: player.auth, conn: player.conn, xp: 0, xpMultiplier: 1, bet: { red: 0, blue: 0 }, hasBet: false };
    }
    else {
